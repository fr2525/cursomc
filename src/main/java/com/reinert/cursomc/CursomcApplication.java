...
import com.reinert.cursomc.domain.Cidade;
...
import com.reinert.cursomc.domain.ItemPedido;
import com.reinert.cursomc.domain.Pagamento;
import com.reinert.cursomc.domain.PagamentoComBoleto;
import com.reinert.cursomc.domain.PagamentoComCartao;
import com.reinert.cursomc.domain.Pedido;
import com.reinert.cursomc.domain.Produto;
import com.reinert.cursomc.domain.enums.EstadoPagamento;
import com.reinert.cursomc.domain.enums.TipoCliente;
import com.reinert.cursomc.repositories.CategoriaRepository;
import com.reinert.cursomc.repositories.CidadeRepository;
import com.reinert.cursomc.repositories.ClienteRepository;
import com.reinert.cursomc.repositories.EnderecoRepository;
import com.reinert.cursomc.repositories.EstadoRepository;
import com.reinert.cursomc.repositories.ItemPedidoRepository;
import com.reinert.cursomc.repositories.PagamentoRepository;
import com.reinert.cursomc.repositories.PedidoRepository;
import com.reinert.cursomc.repositories.ProdutoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Endereco e1 = new Endereco(null, "Rua das Flores", "300","apto. 41", "Jardim", "38280204", cli1, c1);
